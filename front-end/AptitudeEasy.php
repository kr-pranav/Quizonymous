<?php
    ...
    $q1='SELECT QUES_ID,QUESTION,OPT_A,OPT_B,OPT_C,OPT_D,CRCT_ANS FROM QUESTION WHERE DOMAIN="APTITUDE" AND DIFFICULTY=1 ';
...
<html lang="en">
    ...
    <body class="container">
            <div class="jumbotron  ">
                ...
                <h3 class="text-center" >Aptitude - Level 1 (EASY)</h3><br>
