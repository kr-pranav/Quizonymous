<?php
    ...
    $q1='SELECT QUES_ID,QUESTION,OPT_A,OPT_B,OPT_C,OPT_D,CRCT_ANS FROM QUESTION WHERE DOMAIN="APTITUDE" AND DIFFICULTY=3 ';
...
<html lang="en">
    ...
    <div class="container">
            <div class="jumbotron  ">
                ...
                <h3 class="text-center" >Aptitude - Level 3 (HARD)</h3><br>
